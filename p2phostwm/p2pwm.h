...
#define PEER_E_INITIALIZE_FAILED    102
#define PEER_E_NOT_INITIALIZED      103
#define PEER_SHUTDOWN_FAILED        104
#define PEER_SIGNIN_FAILED          105
#define PEER_SIGNOUT_FAILED         105
#define PEER_OBJECTSEND_FAILED      106
#define PEER_ENUMPNM_FAILED         107
#define PEER_ENUMOBJ_FAILED         108
#define PEER_S_NO_CONNECTIVITY      109
#define PEER_S_OBJECT_UPDATED       110
#define PEER_S_OBJECT_ADDED         111
#define PEER_S_OBJECT_DELETED       112
#define PEER_S_OBJECT_NOTEXIST      113
